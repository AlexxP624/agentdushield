...
if (!channel) return message.channel.send(":x: Il n'y a pas de salon de suggestion !");
    ...
    const reply = new MessageEmbed()
      .setDescription(`✅ | Vous avez accepté la suggestion avec succès.`)
      .setColor("00FFFF")
  ...
  return message.channel.send(noMessage);
      ...
      .setColor("GREEN")
        .addField("✅ | Statut : Accepté.", `\`\`\`Raison : ${replyQuery}\`\`\``)
      .setFooter(`Accepté par : ${message.author.tag}`)
      .setTimestamp();
    ...
    const embed = new MessageEmbed()
      .setDescription(`✅ Votre suggestion à été acceptée ! **[Lien du message](https://discord.com/channels/${message.guild.id}/${channel}/${messageID})**`)
      .setColor("GREEN")
      user.send(embed)
